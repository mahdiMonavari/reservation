...
function Register() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center
      ...
      dark:from-emerald-950 dark:via-teal-900 dark:to-emerald-950 p-4 overflow-hidden">
      ...
      <div className="pointer-events-none absolute w-[350px] h-[350px] rounded-full
        border border-emerald-900/10 dark:border-emerald-400/10
        top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />

      <div className="relative w-full max-w-sm">
        <div className="relative bg-white/80 dark:bg-white/5
          ...
          <div className="px-8 pt-8 pb-10">
            ...
            <h1 className="text-xl font-Morabba-Bold text-center
