  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between pt-4 border-t border-emerald-100/50 dark:border-emerald-900/30">
        ...
        <ReservationButton params={service.doctorId}>
          <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-Morabba-Bold text-sm transition-all group/link">
            <span>رزرو نوبت</span>
