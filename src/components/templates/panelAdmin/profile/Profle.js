  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 flex flex-col gap-5">
        ...
        >
          <div
            className="h-24 bg-gradient-to-l from-violet-500 to-slate-400
            dark:from-violet-800 dark:to-slate-700"
          />
          ...
          <div className="px-5 pb-5">
              ...
              <div className="flex items-center gap-2 mt-10">
                {isEditing ? (
                  <>
                    <button
                      onClick={handleSave}
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-Dana-Medium
                        bg-violet-500 hover:bg-violet-600 text-white
                        transition-all duration-150 active:scale-95"
                    >
                      <FaSave size={11} /> ذخیره
                    </button>
                    <button
            ...
            <div className="flex flex-col gap-2">
              <h1 className="text-lg font-Morabba-Bold text-slate-800 dark:text-slate-100">
                {fullName || "نام نامشخص"}
              </h1>
