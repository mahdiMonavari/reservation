...
function Reservation() {
  ...
  return (
    <div className="relative min-h-screen flex items-start justify-center
      ...
      {/* rings */}
      <div className="pointer-events-none absolute w-[700px] h-[700px] rounded-full
        border border-emerald-900/8 dark:border-emerald-500/10
        top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
      <div className="pointer-events-none absolute w-[400px] h-[400px] rounded-full
        border border-emerald-900/8 dark:border-emerald-400/10
        top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
      <div className="pointer-events-none absolute top-1/4 -left-20 w-80 h-80 rounded-full
        bg-emerald-300/10 dark:bg-emerald-500/10 blur-3xl" />
      <div className="pointer-events-none absolute bottom-1/4 -right-20 w-80 h-80 rounded-full
        bg-teal-300/10 dark:bg-teal-400/10 blur-3xl" />
          ...
          <div className="px-10 pt-8 pb-6 border-b border-emerald-100 dark:border-white/5">
            ...
            <div className="flex items-center justify-between mb-7">
              ...
              <div className="text-right">
                <h1 className="text-xl font-Morabba-Bold leading-none
                  ...
                  <React.Fragment key={i}>
                    {i > 0 && (
                      <div className={`flex-1 h-0.5 rounded-full transition-all duration-500
                        ${done
                          ? 'bg-emerald-500'
                          : 'bg-emerald-200 dark:bg-white/15'}`} />
                    )}
          ...
          <div className="px-10 pb-8 pt-3 flex items-center justify-between gap-3
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl
                text-sm font-Morabba-Bold transition-all duration-200 active:scale-[0.97]
            ...
            <button
              ...
              className="relative flex items-center gap-2 px-6 py-2.5 rounded-xl
                text-sm font-Morabba-Bold text-white overflow-hidden
              ...
              <span className="relative z-10">
                {step === STEPS.length ? 'ثبت نهایی ✓' : 'مرحله بعد ›'}
              </span>
              {canProceed && (
